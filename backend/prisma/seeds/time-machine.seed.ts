...
const scenarioA = {
  ...
  contextByYear: {
    '2010': {
      ...
      macro: [
        { label: 'Croissance PIB UEMOA', value: '+4,1%', signal: '↑ Reprise post-crise mondiale — zone résistante', cls: 'positive' },
        { label: 'Taux directeur BCEAO', value: '4,25%', signal: '→ Stabilité monétaire — conditions de crédit favorables', cls: 'neutral' },
        { label: 'Capitalisation BRVM', value: '3 200 Mds FCFA', signal: '↑ +69% sur 2009 — meilleure performance africaine', cls: 'positive' },
        { label: 'Inflation UEMOA', value: '2,1%', signal: '→ Sous contrôle — pouvoir d\'achat préservé', cls: 'neutral' },
        { label: 'Cours du cacao', value: '3 200 $/tonne', signal: '↑ Hausse depuis 2009 — favorable pour agro CI', cls: 'positive' },
        { label: 'Ratio Tier 1 banques', value: '12,4%', signal: '↑ Bien au-dessus des 8% requis — solidité bancaire', cls: 'positive' },
      ],
    },
    '2013': {
      kofiPresentation:
      ...
      macro: [
        { label: 'Croissance PIB UEMOA', value: '+6,1%', signal: '↑ Accélération — CI affiche +10,7% — meilleur taux Afrique subsaharienne', cls: 'positive' },
        { label: 'BRVM Composite 2010-13', value: '+87%', signal: '↑ Bull run historique — capitalisation : 4 000 Mds FCFA', cls: 'positive' },
        { label: 'Taux directeur BCEAO', value: '4,25%', signal: '→ Toujours stable — pas de resserrement en vue', cls: 'neutral' },
        { label: 'Crédit à l\'économie', value: '+15%', signal: '↑ Fort dynamisme bancaire — bon signe pour SIB et SGBCI', cls: 'positive' },
        { label: 'Cours cacao', value: '2 800 $/tonne', signal: '→ Légèrement inférieur à 2010 — effet neutre sur l\'agro CI', cls: 'neutral' },
        { label: 'Inflation UEMOA', value: '2,3%', signal: '→ Toujours maîtrisée', cls: 'neutral' },
      ],
    },
    '2016': {
      kofiPresentation:
      ...
      macro: [
        { label: 'Croissance PIB UEMOA', value: '+6,4%', signal: '↑ Cycle de croissance intact malgré la correction boursière', cls: 'positive' },
        { label: 'BRVM Composite 2015', value: '+17,8%', signal: '↑ Meilleure performance parmi les bourses africaines 2015', cls: 'positive' },
        { label: 'Cours du cacao', value: '2 800 $/tonne', signal: '↓ -20% depuis le pic de 2014 — pression sur valeurs agro', cls: 'negative' },
        { label: "Cours de l'huile de palme", value: '640 $/tonne', signal: '↓ -20% — impact direct PALM CI, SOGB, SAPH', cls: 'negative' },
        { label: 'Data mobile UEMOA', value: '+45% YoY', signal: '↑ Explosion de la data — très favorable aux télécoms', cls: 'positive' },
        { label: 'Taux directeur BCEAO', value: '4,25%', signal: '→ Toujours stable — 7 ans sans changement', cls: 'neutral' },
      ],
    },
    '2019': {
      kofiPresentation:
      ...
      macro: [
        { label: 'Croissance PIB UEMOA', value: '+6,6%', signal: "↑ L'un des cycles de croissance les plus solides d'Afrique", cls: 'positive' },
        { label: 'Capitalisation BRVM', value: '5 000+ Mds FCFA', signal: '↑ Record historique — BRVM devient référence continentale', cls: 'positive' },
        { label: 'Inflation UEMOA', value: '1,5%', signal: '↓ Très faible — pouvoir d\'achat préservé', cls: 'positive' },
        { label: 'Mobile money CI', value: '+60% YoY', signal: "↑ Wave, Orange Money transforment l'économie informelle", cls: 'positive' },
        { label: 'Transferts diaspora', value: '+8%', signal: '↑ Flux entrants en hausse — soutien consommation', cls: 'positive' },
        { label: 'Taux directeur BCEAO', value: '4,25%', signal: '→ Toujours stable — 9 ans sans changement', cls: 'neutral' },
      ],
    },
    '2022': {
      kofiPresentation:
      ...
      macro: [
        { label: 'BRVM Composite 2021', value: '+22%', signal: '↑ Rebond post-COVID confirmé — effacement des pertes 2020', cls: 'positive' },
        { label: 'Capitalisation BRVM', value: '7 560 Mds FCFA', signal: "↑ Record historique grâce à l'IPO Orange CI", cls: 'positive' },
        { label: 'Inflation UEMOA', value: '+7,4%', signal: '↓ Choc importé — guerre Ukraine / hausse prix alimentaires', cls: 'negative' },
        { label: 'S&P 500 (référence)', value: '-20% sur 2022', signal: '↑ La BRVM fait mieux que Wall Street en 2022', cls: 'positive' },
        { label: 'Taux directeur BCEAO', value: '4,75%', signal: "↑ Premier relèvement depuis 2010 — prudence obligatoire", cls: 'warning' },
        { label: 'Croissance UEMOA 2021', value: '+6,1%', signal: '↑ Rebond fort post-COVID — économie réelle solide', cls: 'positive' },
      ],
    },
  },
...
const scenarioB = {
  ...
  contextByYear: {
    '2008': {
      ...
      macro: [
        { label: 'S&P 500 (États-Unis)', value: '-36% depuis janv.', signal: '↓ Krach historique — le marché efface 10 ans de gains', cls: 'negative' },
        { label: 'Indice bancaire européen', value: '-45% depuis janv.', signal: '↓ Effondrement du secteur financier mondial', cls: 'negative' },
        { label: 'CAC 40 (France)', value: '-43% depuis janv.', signal: '↓ Banques françaises très exposées aux produits dérivés', cls: 'negative' },
        { label: 'Tier 1 banques UEMOA', value: '12,4%', signal: "↑ Aucune banque UEMOA n'est exposée aux subprimes", cls: 'positive' },
        { label: 'Exposition BRVM aux CDO/MBS', value: '~0%', signal: '↑ Avantage structurel majeur des banques africaines', cls: 'positive' },
        { label: 'BRVM Composite recul', value: '-6%', signal: '→ Contagion psychologique uniquement — pas fondamentale', cls: 'warning' },
      ],
    },
    '2009': {
      kofiPresentation:
      ...
      macro: [
        { label: 'S&P 500', value: '666 points', signal: '↓ Point bas historique — -57% depuis le sommet 2007', cls: 'negative' },
        { label: 'BRVM bancaires', value: '-28% depuis sept. 2008', signal: '↓ Contagion maximale — mais fondamentaux toujours sains', cls: 'negative' },
        { label: 'BRVM Composite', value: '-22% depuis janv. 2008', signal: "↓ Pire recul de l'histoire récente de la BRVM", cls: 'negative' },
        { label: 'Résultats SGBCI 2008', value: 'BNA +8%', signal: '↑ Bénéfices en hausse malgré la crise — signal fort', cls: 'positive' },
        { label: 'Résultats SONATEL 2008', value: 'BNA +14%', signal: '↑ Dividende maintenu — résistance opérationnelle', cls: 'positive' },
        { label: 'PER bancaires BRVM', value: '5,8×', signal: "↑ Historiquement bas — signal d'achat pour les investisseurs disciplinés", cls: 'positive' },
      ],
    },
    '2010': {
      kofiPresentation:
      ...
      macro: [
        { label: 'BRVM Composite déc. 2010', value: '+68%', signal: '↑ Effacement total des pertes + progression significative', cls: 'positive' },
        { label: 'SGBCI cours', value: '12 500 FCFA', signal: '↑ +52% vs point bas mars 2009 (8 200 FCFA)', cls: 'positive' },
        { label: 'SONATEL cours', value: '16 000 FCFA', signal: '↑ +42% vs point bas mars 2009 (11 300 FCFA)', cls: 'positive' },
        { label: 'S&P 500 déc. 2010', value: '+48%', signal: '↑ Rebond US depuis le point bas mars 2009', cls: 'positive' },
        { label: 'Zone UEMOA croissance', value: '+5,1%', signal: '↑ Accélération économique post-crise', cls: 'positive' },
        { label: 'BRVM capitalisation', value: '3 200 Mds FCFA', signal: "↑ Record historique à l'époque", cls: 'positive' },
      ],
    },
  },
