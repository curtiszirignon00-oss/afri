...
const scenarioA = {
      ...
      news: [
        {
          ...
          date: '31 déc. 2018',
          tag: 'Capitalisation record',
          sentiment: 'positive',
          text: "La BRVM franchit les 5 000 milliards FCFA de capitalisation boursière. Les bancaires publient des résultats records portés par le boom du crédit à la consommation. La BRVM accueille 2 nouvelles sociétés en 2018, portant le total à 46 titres cotés. SONATEL, après son sommet de 2016, a corrigé sous la pression de Wave CI mais maintient ses dividendes.",
        },
        {
          src: 'Jeune Afrique',
          date: '15 janv. 2019',
  ...
  fundamentalsByYear: {
    '2010': {
      ...
      SLBC: { per: '11,2×', pbr: '2,8×', bna: '+9%', div: 800, cours: 9990, note: 'Quasi-monopole sur la bière ivoirienne. Revenus défensifs — la consommation de bière est peu sensible aux cycles économiques. Dividende 800 FCFA = rendement 8% : l\'un des plus élevés de la BRVM. Valeur refuge par excellence.', kofiAnalysis: 'Rendement dividende 8% = flux de revenus passifs très solide. Modèle défensif : peu corrélé au cycle économique. Joue le rôle de stabilisateur dans un portefeuille par ailleurs plus offensif.' },
    ...
    '2013': {
      SNTS: { per: '13×', pbr: '3,1×', bna: '+18%', div: 900, cours: 22000, note: "Bull run : +57% depuis 2010. Croissance data mobile accélérée. BNA +18%. Dividende porté à 900 FCFA. Mobile money en émergence.", kofiAnalysis: 'PER 13× mais BNA +18% justifie la prime. Bull run BRVM +26%. La thèse data mobile se confirme — SNTS dépasse les 20 000 FCFA pour la première fois.' },
      ...
      SLBC: { per: '14×', pbr: '3,5×', bna: '+12%', div: 1000, cours: 20000, note: 'Bull run exceptionnel : +100% depuis 2010 (9 990 → 20 000 FCFA). Dividende en hausse à 1 000 FCFA. Valorisation au sommet du cycle.', kofiAnalysis: 'PER 14× = valorisation tendue au sommet du bull run. Dividende 5% encore attractif. Candidat à l\'allègement partiel pour sécuriser les gains (+100%).' },
      ...
      BOABF: { per: '7×', pbr: '1,1×', bna: '+12%', div: 100, cours: 2049, note: 'Progression modérée +14% depuis 2010 (1 800 → 2 049 FCFA). Expansion crédit au Burkina portée par la croissance agricole.', kofiAnalysis: '+14% depuis 2010 — en retrait vs bull run général. Croissance crédit agricole solide. Stabilité politique BF confirmée. Maintenir exposition Sahel.' },
    },
    '2016': {
      SNTS: { per: '10×', pbr: '2,8×', bna: '+15%', div: 850, cours: 25000, note: 'Sommet historique à 25 000 FCFA. +13,6% depuis 2013, +78,6% depuis 2010. La révolution data mobile tient toutes ses promesses. Mobile money en plein essor.', kofiAnalysis: 'Record à 25 000 FCFA — valorisation au plus haut. PER 10× correct mais pas bon marché. Dividende 850 FCFA solide. Prudence sur le renforcement au sommet : le titre peut corriger si la concurrence s\'intensifie.' },
      ...
      SLBC: { per: '11×', pbr: '2,9×', bna: '+10%', div: 1100, cours: 17750, note: 'Correction modérée -11% depuis le sommet 2013 (20 000 → 17 750 FCFA). Résiste bien à la correction générale. Dividende 1 100 FCFA maintenu.', kofiAnalysis: 'Meilleure résistance à la correction : -11% vs correction générale. Dividende 1 100 FCFA = rendement 6,2%. Valeur refuge prouvée en période difficile.' },
      SIBC: { per: '6×', pbr: '0,5×', bna: '-35%', div: 100, cours: 2380, note: 'Forte correction depuis 2013 (5 500 → 2 380 FCFA, -57%). Pression sur le portefeuille crédit. Provisions en hausse. Bilan sous tension.', kofiAnalysis: '-57% depuis 2013 = correction majeure malgré le rebond du marché CI. PER 6× mais BNA en recul. Fondamentaux dégradés. Position risquée — attendre signal de stabilisation avant d\'y toucher.' },
      CIEC: { per: '4,5×', pbr: '1,2×', bna: '+55%', div: 120, cours: 3725, note: 'Forte performance : +107% depuis 2010 (1 800 → 3 725 FCFA). Revenus contractuels indexés — avantage structurel durable. Concessionnaire électricité CI : quasi-monopole régulé.', kofiAnalysis: 'CIEC surprend : +107% depuis 2010 malgré une réputation de stabilisateur. PER 4,5× = encore décoté. Dividende 120 FCFA = rendement 3,2%. Candidat à la conservation ou au renforcement si sous-pondéré.' },
      ...
      BICC: { per: '7×', pbr: '1,8×', bna: '+37%', div: 450, cours: 9890, note: 'Forte performance : +37% depuis 2013 (7 200 → 9 890 FCFA). Résultats bancaires solides portés par la reprise économique CI. Dividende en hausse à 450 FCFA.', kofiAnalysis: '+80% depuis 2010 — l\'une des meilleures progressions bancaires du lot. PER 7× = encore raisonnable malgré la hausse. Dividende 450 FCFA = rendement 4,6%. Maintenir ou renforcer si sous-pondéré.' },
      ...
      CFAC: { per: 'N/A', pbr: '0,3×', bna: '-74%', div: 20, cours: 620, note: 'Effondrement -74% depuis 2010 (2 400 → 620 FCFA). Difficultés structurelles profondes. Dividende quasi suspendu — 20 FCFA symboliques.', kofiAnalysis: '-74% depuis 2010 malgré le bull run général = signal d\'alarme fort. Secteur assurance CI en crise structurelle. Dividende symbolique 20 FCFA. Position spéculative — uniquement pour investisseurs à très haute tolérance au risque.' },
      BOABF: { per: '5×', pbr: '1,5×', bna: '+70%', div: 120, cours: 3488, note: 'Forte progression +70% depuis 2013 (2 049 → 3 488 FCFA). Expansion crédit accélérée. Sommet historique pour BOA BF.', kofiAnalysis: '+94% depuis 2010 — excellente performance. Cours au sommet. PER 5× = encore raisonnable. Dividende 120 FCFA = rendement 3,4%. Maintenir mais rester vigilant sur l\'instabilité sahélienne qui monte.' },
    },
    '2019': {
      SNTS: { per: '8×', pbr: '2,0×', bna: '-5%', div: 1000, cours: 16900, note: 'Correction -32% depuis le sommet 2016 (25 000 → 16 900 FCFA). Wave CI intensifie la concurrence sur le mobile money. BRVM Composite en recul. Dividende 1 000 FCFA maintenu.', kofiAnalysis: '-32% depuis le sommet 2016. PER 8× = valorisation historiquement basse pour SONATEL. Wave érode les revenus data, mais le dividende tient (rendement 5,9%). Point d\'entrée pour l\'investisseur patient.' },
      ...
      SLBC: { per: 'N/A', pbr: '0,8×', bna: '-60%', div: 200, cours: 4500, note: 'Chute spectaculaire -75% depuis 2016 (17 750 → 4 500 FCFA). Difficultés opérationnelles majeures. Dividende drastiquement réduit à 200 FCFA.', kofiAnalysis: 'Krach -75% en 3 ans = situation de détresse. Aucun PER applicable (pertes probables). Dividende résiduel 200 FCFA = signal de survie. Position spéculative uniquement — attendre un signal de stabilisation avant d\'entrer.' },
      SIBC: { per: 'N/A', pbr: '0,3×', bna: '-41%', div: 50, cours: 1412, note: 'Poursuite de la baisse (-41% depuis 2016, 2 380 → 1 412 FCFA). Pertes enregistrées. Banque sous surveillance réglementaire.', kofiAnalysis: 'Accélération de la baisse. À 1 412 FCFA, le marché anticipe des difficultés structurelles. Aucun PER applicable. Position très risquée — ne pas renforcer sans signal clair de redressement de la direction ou de recapitalisation.' },
      CIEC: { per: '5×', pbr: '0,5×', bna: '-59%', div: 50, cours: 1510, note: 'Correction importante -59% depuis 2016 (3 725 → 1 510 FCFA). Révision tarifaire défavorable — contrat de concession électricité rénégocié à la baisse par l\'État CI.', kofiAnalysis: '-59% depuis 2016 = choc réglementaire majeur. Revenus contractuels rénégociés défavorablement. PER 5× = valorisation basse. Patience requise — potentiel de rebond si la nouvelle tarification est recalibrée.' },
      ...
      BICC: { per: '9×', pbr: '1,2×', bna: '-31%', div: 280, cours: 6795, note: 'Correction -31% depuis le sommet 2016 (9 890 → 6 795 FCFA). Qualité bilancielle maintenue. Dividende réduit à 280 FCFA mais maintenu.', kofiAnalysis: '-31% depuis le sommet 2016. PER 9× = valorisation correcte. Dividende 280 FCFA = rendement 4,1%. Correction de marché, pas fondamentale — point d\'achat potentiel pour l\'investisseur patient.' },
      ECOC: { per: '7×', pbr: '0,9×', bna: '+5%', div: 150, cours: 3990, note: 'Légère correction depuis 2016 (3 800 → 3 990 FCFA, +5%). Performance en ligne avec le marché. Dividende réduit à 150 FCFA.', kofiAnalysis: 'Quasi-stabilité depuis 2016. PER 7× = valorisation raisonnable. Dividende 150 FCFA = rendement 3,8%. Profil stable sans grand dynamisme — à maintenir si déjà en portefeuille.' },
      CFAC: { per: 'N/A', pbr: '0,2×', bna: '-35%', div: 10, cours: 405, note: 'Poursuite de la chute -35% depuis 2016 (620 → 405 FCFA). Pertes enregistrées. Dividende symbolique 10 FCFA.', kofiAnalysis: 'Accélération de la chute. Cours à 405 FCFA = prix de détresse. Aucun PER applicable. Position très spéculative — à éviter sauf fort appétit pour le risque et conviction de redressement.' },
      BOABF: { per: '6×', pbr: '0,8×', bna: '-47%', div: 60, cours: 1848, note: 'Forte correction -47% depuis le sommet 2016 (3 488 → 1 848 FCFA). Montée de l\'instabilité sahélienne. Dividende réduit à 60 FCFA.', kofiAnalysis: '-47% depuis 2016 = correction liée à la montée des tensions au Sahel et au ralentissement du crédit BF. PER 6× = valorisation basse. Dividende 60 FCFA. Position risquée — potentiel de rebond si le contexte sécuritaire s\'améliore.' },
    },
    '2022': {
      SNTS: { per: '12×', pbr: '2,3×', bna: '-10%', div: 950, cours: 15200, note: 'Poursuite de la correction depuis le sommet 2016 (-39%). Exposition Sahel (Mali ~15% des revenus) sous pression après instabilité régionale. Dividende 950 FCFA maintenu.', kofiAnalysis: '-39% depuis le sommet 2016. Marché punit l\'exposition sahélienne et la pression Wave. Dividende 950 FCFA = rendement 6,3% = plancher de soutien. PER 12× = pas encore bon marché. À surveiller avant renforcement.' },
      ...
      SLBC: { per: '14×', pbr: '1,5×', bna: '+85%', div: 350, cours: 8325, note: 'Rebond +85% depuis le point bas 2019 (4 500 → 8 325 FCFA). Restructuration portant ses fruits. Dividende en reprise à 350 FCFA.', kofiAnalysis: '+85% de rebond depuis 2019. PER 14× = valorisation correcte pour une valeur en redressement. Dividende 350 FCFA = rendement 4,2%. Momentum positif — surveiller la pérennité du redressement opérationnel.' },
      SIBC: { per: '7×', pbr: '0,6×', bna: '+62%', div: 80, cours: 2292, note: 'Rebond +62% depuis le point bas 2019 (1 412 → 2 292 FCFA). Stabilisation bilancielle en cours. Dividende partiel rétabli.', kofiAnalysis: '+62% depuis le point bas 2019 = rebond de valorisation. PER 7× = décoté vs secteur. Dividende symbolique 80 FCFA. Potentiel de continuation si la restructuration est réelle — risque résiduel élevé.' },
      CIEC: { per: '5×', pbr: '0,7×', bna: '+32%', div: 60, cours: 1990, note: 'Rebond partiel +32% depuis le point bas 2019 (1 510 → 1 990 FCFA). Normalisation réglementaire en cours. Revenus en redressement progressif.', kofiAnalysis: '+32% depuis 2019. PER 5× = encore décoté. Dividende symbolique 60 FCFA. Potentiel de revalorisation si le contrat de concession est stabilisé — mais risque réglementaire persistant.' },
      ...
      BICC: { per: '10×', pbr: '1,2×', bna: '+1%', div: 280, cours: 6850, note: 'Stabilisation autour de 6 800-6 900 FCFA depuis 2019. Digitalisation bancaire en cours. Dividende 280 FCFA maintenu.', kofiAnalysis: 'Cours stable depuis 2019. PER 10× = valorisation correcte. Dividende 280 FCFA = rendement 4,1%. Valeur de rendement stable — potentiel de revalorisation via digitalisation accélérée post-COVID.' },
      ECOC: { per: '8×', pbr: '1,1×', bna: '+24%', div: 200, cours: 4945, note: 'Rebond +24% depuis 2019 (3 990 → 4 945 FCFA). Croissance crédit reprise. Digitalisation bancaire accélère post-COVID.', kofiAnalysis: '+24% depuis 2019. PER 8× = valorisation raisonnable. Dividende 200 FCFA = rendement 4,0%. Profil en amélioration progressive — candidat au renforcement si budget disponible.' },
      CFAC: { per: '10×', pbr: '0,5×', bna: '+130%', div: 30, cours: 930, note: 'Rebond remarquable +130% depuis le point bas 2019 (405 → 930 FCFA). Redressement en cours. Dividende partiel rétabli à 30 FCFA.', kofiAnalysis: '+130% depuis 2019 = rebond spéculatif fort. PER 10× sur une base bénéficiaire basse. Dividende 30 FCFA = signal de survie. Potentiel de continuation si le redressement se confirme — risque résiduel élevé.' },
      BOABF: { per: '5×', pbr: '1,1×', bna: '+41%', div: 80, cours: 2600, note: 'Rebond +41% depuis le point bas 2019 (1 848 → 2 600 FCFA). Coup d\'état BF 2022 crée une décote de risque géopolitique. Fondamentaux opérationnels préservés.', kofiAnalysis: '+41% depuis 2019 malgré la tension géopolitique au Burkina. PER 5× = décote risque politique persistante. Dividende 80 FCFA = rendement 3,1%. Potentiel de revalorisation si stabilisation politique — à pondérer selon appétit au risque.' },
    },
  },

  dividendsByYear: {
    '2010': { SNTS: 700, SGBC: 500, PALC: 250, SLBC: 800, SIBC: 200, CIEC: 90, ETIT: 1, BICC: 350, ECOC: 200, CFAC: 150, BOABF: 80 },
    '2013': { SNTS: 900, SGBC: 700, PALC: 320, SLBC: 1000, SIBC: 280, CIEC: 120, ETIT: 1.5, BICC: 450, ECOC: 280, CFAC: 200, BOABF: 100 },
    '2016': { SNTS: 850, SGBC: 600, PALC: 200, SLBC: 1100, SIBC: 100, CIEC: 120, ETIT: 1, BICC: 450, ECOC: 220, CFAC: 20, BOABF: 120 },
    '2019': { SNTS: 1000, SGBC: 800, PALC: 350, SLBC: 200, SIBC: 50, CIEC: 50, ETIT: 1.5, BICC: 280, ECOC: 150, CFAC: 10, BOABF: 60 },
    '2022': { SNTS: 950, SGBC: 900, PALC: 300, SLBC: 350, SIBC: 80, CIEC: 60, ORCI: 0, ETIT: 2, BICC: 280, ECOC: 200, CFAC: 30, BOABF: 80 },
  },
  ...
  availableActionsByYear: {
    ...
    '2016': {
      ...
      canSell: ['SNTS', 'SGBC', 'PALC', 'SLBC', 'SIBC', 'CIEC', 'ETIT', 'BICC', 'ECOC', 'CFAC', 'BOABF'],
      consequences: [
        { condition: 'rotationAgro === true', positive: true, result: 'PALM CI rebondit à 7 200 FCFA en 2019 (+71% depuis le point bas 2016). Avoir maintenu les valeurs agricoles déprimées se révèle payant — les fondamentaux avaient raison contre le sentiment de marché.', lesson: 'La rotation sectorielle fondée sur les fondamentaux (acheter l\'agro déprimé, alléger les télécoms au sommet) produit de la valeur sur le long terme.' },
