...
async function verifyCBIBFData() {
  try {
    console.log('🔍 Vérification complète des données CBIBF...\n');

    const ticker = 'CBIBF';

    // 1. Stock
    console.log('📊 Stock CBIBF:');
    ...
    // 2. Fondamentaux
    console.log('💰 Données fondamentales CBIBF:');
    ...
    console.log('🏢 Informations compagnie CBIBF:');
    ...
    // 4. Actionnaires
    console.log('👥 Actionnaires CBIBF:');
    ...
    console.log('📅 Données financières annuelles CBIBF:');
