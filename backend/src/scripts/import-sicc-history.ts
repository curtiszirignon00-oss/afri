...
async function importSICCHistory() {
  try {
    console.log('🚀 Démarrage de l\'import des données historiques SICC...\n');

    const ticker = 'SICC';
    const excelPath = 'C:\\Users\\HP\\OneDrive\\Desktop\\actions brvm\\sicc\\sicc.xlsx';
