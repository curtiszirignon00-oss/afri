...
async function importFTSCHistory() {
  try {
    console.log('🚀 Démarrage de l\'import des données historiques FTSC...\n');

    const ticker = 'FTSC';
    const excelPath = 'C:\\Users\\HP\\OneDrive\\Desktop\\actions brvm\\ftsc\\FTSC.xlsx';
