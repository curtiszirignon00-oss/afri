...
async function verifyBOABFData() {
  try {
    console.log('🔍 Vérification complète des données BOABF...\n');

    const ticker = 'BOABF';

    // 1. Stock
    console.log('📊 Stock BOABF:');
    ...
    // 2. Fondamentaux
    console.log('💰 Données fondamentales BOABF:');
    ...
    console.log('🏢 Informations compagnie BOABF:');
    ...
    // 4. Actionnaires
    console.log('👥 Actionnaires BOABF:');
    ...
    console.log('📅 Données financières annuelles BOABF:');
