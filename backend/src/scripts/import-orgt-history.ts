...
async function importORGTHistory() {
  try {
    console.log('🚀 Démarrage de l\'import des données historiques ORGT...\n');

    const ticker = 'ORGT';
    const excelPath = 'C:\\Users\\HP\\OneDrive\\Desktop\\actions brvm\\orgt\\orgt.xlsx';
