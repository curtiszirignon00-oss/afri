...
async function importUNXCHistory() {
  try {
    console.log('🚀 Démarrage de l\'import des données historiques UNXC...\n');

    const ticker = 'UNXC';
    const excelPath = 'C:\\Users\\HP\\OneDrive\\Desktop\\actions brvm\\unxc\\UNXC.xlsx';
