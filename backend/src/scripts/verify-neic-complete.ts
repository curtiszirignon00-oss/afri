...
async function verifyNEICComplete() {
  try {
    console.log('🔍 Vérification complète des données NEIC...\n');
    ...
    // 2. Fondamentaux
    console.log('💰 Données fondamentales NEIC:');
    ...
    if (fundamentals) {
      ...
      console.log(`  ✅ PER: ${fundamentals.pe_ratio || 'N/A (perte en 2024)'}`);
      ...
      console.log(`  ✅ BPA: ${fundamentals.eps || 'N/A (perte en 2024)'} FCFA`);
    ...
    console.log('🏢 Informations compagnie NEIC:');
    ...
    console.log('📅 Données financières annuelles NEIC:');
