...
async function verifyNTLCData() {
  try {
    console.log('🔍 Vérification complète des données NTLC...\n');

    const ticker = 'NTLC';

    // 1. Stock
    console.log('📊 Stock NTLC:');
    ...
    // 2. Fondamentaux
    console.log('💰 Données fondamentales NTLC:');
    ...
    console.log('🏢 Informations compagnie NTLC:');
    ...
    console.log('📅 Données financières annuelles NTLC:');
    ...
    console.log('📈 Données historiques NTLC:');
