...
async function verifySIVCData() {
  try {
    console.log('🔍 Vérification complète des données SIVC...\n');

    const ticker = 'SIVC';

    // 1. Stock
    console.log('📊 Stock SIVC:');
    ...
    console.log('📈 Données historiques SIVC:');
    ...
    // 3. Fondamentaux
    console.log('💰 Données fondamentales SIVC:');
    ...
    console.log('🏢 Informations compagnie SIVC:');
    ...
    console.log('📅 Données financières annuelles SIVC:');
