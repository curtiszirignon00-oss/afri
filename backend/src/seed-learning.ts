    ...
    <div class="space-y-8 max-w-4xl mx-auto">
        ...
        <div class="bg-gradient-to-r from-teal-600 to-cyan-700 text-white p-8 rounded-2xl shadow-lg">
            ...
            <p class="text-lg mb-6 text-teal-50">
                [cite_start]Définir ses Objectifs et son Horizon[cite: 1]. [cite_start]À la fin de ce module, vous serez capable de : [cite: 3]
            </p>
            <ul class="space-y-3 text-lg">
                <li class="flex items-start gap-3">
                    <span class="bg-white/20 rounded-full p-1 mt-1">
                    ...
                    [cite_start]<strong>Définir précisément votre horizon de placement</strong> (court, moyen, long terme) en fonction de vos objectifs. [cite: 4]
                </li>
                <li class="flex items-start gap-3">
                    <span class="bg-white/20 rounded-full p-1 mt-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    </span>
                    [cite_start]<strong>Comprendre le rôle du temps</strong> pour gérer le risque et la volatilité. [cite: 5]
                </li>
                <li class="flex items-start gap-3">
                    <span class="bg-white/20 rounded-full p-1 mt-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    </span>
                    [cite_start]<strong>Établir votre profil d'investisseur</strong> et déterminer l'allocation d'actifs cohérente. [cite: 6]
                </li>
            </ul>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p class="text-gray-600 mb-4">
                [cite_start]La bourse n'est pas un jeu, c'est un outil pour réaliser vos projets de vie. [cite: 8] [cite_start]Avant de choisir un titre, vous devez définir la durée pendant laquelle vous pouvez vous passer de cet argent. [cite: 9]
            </p>
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 mb-4">
                    [cite_start]C'est la période pendant laquelle vous prévoyez de garder votre investissement. [cite: 11] [cite_start]Cette durée dicte le niveau de risque que vous pouvez vous permettre. [cite: 12]
                </p>
            </div>
            ...
            <div class="overflow-x-auto mb-6">
                ...
                [cite_start]<div class="text-xs text-gray-400 mt-1 text-right">[cite: 13]</div>
            </div>

            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
                <p class="text-yellow-800">
                    [cite_start]<strong>💡 Conseil d'Expert :</strong> Chaque grand objectif de vie (retraite, études, maison) doit être traité comme un compte d'investissement séparé, avec son propre horizon. [cite: 14]
                </p>
            </div>
        </div>
        ...
        <div class="bg-indigo-900 text-white p-8 rounded-xl shadow-md relative overflow-hidden">
            <div class="relative z-10">
                <h2 class="text-2xl font-bold mb-4 text-indigo-200">
                    [cite_start]🚌 5.1.2 Le Pouvoir du Temps : L'Analogie du Car de Nuit [cite: 15]
                </h2>
                ...
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                        ...
                        <p class="text-indigo-100 mb-4 text-sm leading-relaxed">
                            [cite_start]À court terme, les marchés peuvent être erratiques. [cite: 16] [cite_start]Si vous regardez par la fenêtre, le paysage est flou et scintillant (volatilité quotidienne). [cite: 21] Vous ne voyez que les secousses.
                        </p>
                        
                        <h3 class="font-bold text-white mb-2">La Destination (Long terme)</h3>
                        <p class="text-indigo-100 text-sm leading-relaxed">
                            [cite_start]Historiquement, les marchés ont toujours eu une tendance haussière sur des décennies. [cite: 18] [cite_start]Si vous fixez l'horloge et la destination, vous savez que vous arriverez à bon port malgré les cahots. [cite: 22]
                        </p>
                    </div>
                    <div class="bg-white/10 p-4 rounded-lg backdrop-blur-sm border border-white/20">
                            ...
                            [cite_start]"L'investisseur à long terme se concentre sur la destination, pas sur les secousses." [cite: 23]
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <h2 class="text-2xl font-bold text-gray-800 mb-4 border-b border-teal-100 pb-2 flex items-center gap-2">
                [cite_start]⚖️ 5.2 Lien entre horizon et allocation [cite: 24]
            </h2>

            <div class="mb-6">
                <p class="text-gray-600 mb-4">
                    [cite_start]Votre profil est défini par votre <strong>tolérance au risque</strong> : votre capacité émotionnelle (accepter le stress) et financière (ne pas avoir besoin de l'argent) à subir une perte. [cite: 26, 27, 28]
                </p>
                <blockquote class="border-l-4 border-teal-500 pl-4 italic text-gray-600 my-4 bg-gray-50 py-2 pr-2 rounded-r">
                    “If you aren't willing to own a stock for ten years, don't even think about owning it for ten minutes.” [cite_start]— Warren Buffett [cite: 29]
                </blockquote>
            </div>

             
            [cite_start]<h3 class="text-lg font-bold text-teal-700 mb-3 mt-6">Les Trois Profils d'Investisseur [cite: 30]</h3>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                ...
                [cite_start]<div class="text-xs text-gray-400 mt-1 text-right">[cite: 32]</div>
            </div>

            <div class="mt-4 bg-teal-50 p-4 rounded-lg text-sm text-teal-900">
                [cite_start]<strong>Exemple :</strong> Mamadou (25 ans, retraite) est <strong>Dynamique</strong>[cite: 33]. [cite_start]Mamadou (55 ans, achat maison dans 3 ans) est <strong>Prudent</strong>[cite: 34].
            </div>
        </div>
        ...
        <div class="bg-gray-50 p-6 rounded-xl border-2 border-dashed border-gray-300">
            ...
            <div class="space-y-6">
                <div class="bg-white p-4 rounded-lg shadow-sm">
                    <h3 class="font-bold text-gray-800 mb-2">1. [cite_start]Question Émotionnelle [cite: 41]</h3>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li class="flex items-center gap-2">
                            ...
                            Je vends tout pour sauver les meubles. [cite_start]<span class="font-bold text-blue-600">→ Prudent</span> [cite: 42]
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="w-6 h-6 rounded-full border flex items-center justify-center text-gray-500">B</span>
                            Je stresse mais j'attends. [cite_start]<span class="font-bold text-yellow-600">→ Équilibré</span> [cite: 43]
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="w-6 h-6 rounded-full border flex items-center justify-center text-gray-500">C</span>
                            J'achète plus à bas prix ! [cite_start]<span class="font-bold text-red-600">→ Dynamique</span> [cite: 44]
                        </li>
                    </ul>
                </div>

                <div class="bg-white p-4 rounded-lg shadow-sm">
                    [cite_start]<h3 class="font-bold text-gray-800 mb-2">Synthèse de la Stratégie [cite: 47]</h3>
                    <div class="overflow-x-auto">
        ...
        <div class="bg-teal-900 text-teal-50 p-8 rounded-xl">
            [cite_start]<h2 class="text-2xl font-bold text-white mb-4">🧠 Les Termes à Maîtriser [cite: 48]</h2>
            <div class="grid md:grid-cols-2 gap-4 text-sm mb-8">
                <div>
                    [cite_start]<strong class="text-white">Horizon de Placement :</strong> La durée de détention prévue de l'actif. [cite: 49]
                </div>
                <div>
                    [cite_start]<strong class="text-white">Volatilité :</strong> L'intensité des variations de prix. [cite: 49]
                </div>
                <div>
                    [cite_start]<strong class="text-white">Allocation d'Actifs :</strong> Répartition du capital (Actions vs Obligations). [cite: 49]
                </div>
            </div>
            ...
            <div class="text-center">
                ...
                [cite_start]<p class="mb-6">Vous savez désormais que le temps est votre plus grand atout. [cite: 51]</p>
                <div class="inline-block bg-teal-600 hover:bg-teal-500 text-white px-6 py-3 rounded-lg transition-colors font-bold shadow-lg cursor-pointer">
                    [cite_start]👉 Prochaine leçon : Module 6 — Le Mental du Gagnant [cite: 52]
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-purple-800 to-indigo-900 text-white p-8 rounded-2xl shadow-lg">
            ...
            <ul class="space-y-3 text-lg">
                <li class="flex items-start gap-3">
                    ...
                    [cite_start]<strong>Comprendre les principes de la finance comportementale</strong> et distinguer l'investissement de la spéculation[cite: 56].
                </li>
                <li class="flex items-start gap-3">
                    <span class="bg-white/20 rounded-full p-1 mt-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    </span>
                    [cite_start]<strong>Identifier les biais cognitifs et émotionnels</strong> (peur, avidité) pour éviter les pièges[cite: 57].
                </li>
                <li class="flex items-start gap-3">
                    <span class="bg-white/20 rounded-full p-1 mt-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    </span>
                    [cite_start]<strong>Utiliser le pouvoir des intérêts composés</strong> pour bâtir une vision long terme[cite: 59].
                </li>
            </ul>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-purple-500 mb-6">
                <p class="text-gray-700 italic">
                    [cite_start]"Sur les marchés financiers, la plus grande menace pour votre portefeuille n'est pas la crise économique, mais l'homme qui se regarde dans le miroir : <strong>vous-même</strong>." [cite: 61]
                </p>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr>
                            ...
                            [cite_start]<td class="px-4 py-3">Acquérir une part d’entreprise (Valeur interne) [cite: 65]</td>
                            [cite_start]<td class="px-4 py-3">Parier sur le prix à court terme [cite: 65]</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-3 font-bold text-gray-600">Horizon</td>
                            [cite_start]<td class="px-4 py-3 text-green-600 font-bold">Long terme (années) [cite: 65]</td>
                            [cite_start]<td class="px-4 py-3 text-red-500 font-bold">Court terme (jours) [cite: 65]</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-3 font-bold text-gray-600">Moteur</td>
                            [cite_start]<td class="px-4 py-3">Patience, fondamentaux [cite: 65]</td>
                            [cite_start]<td class="px-4 py-3">Excitation ou Panique [cite: 65]</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-8">
                <div class="bg-rose-50 p-5 rounded-xl border border-rose-100">
                    ...
                    [cite_start]<p class="text-xs font-bold text-rose-700">Conséquence : Transforme une perte temporaire en perte réelle[cite: 71].</p>
                </div>
                <div class="bg-amber-50 p-5 rounded-xl border border-amber-100">
                    ...
                    [cite_start]<p class="text-xs font-bold text-amber-700">Conséquence : Achat de titres surévalués[cite: 71].</p>
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        [cite_start]<strong class="text-gray-800">Le Biais de Confirmation :</strong> Chercher uniquement les infos qui confortent votre choix initial[cite: 74].
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    <div class="bg-purple-100 p-2 rounded text-purple-600 mt-1">2</div>
                    <div>
                        [cite_start]<strong class="text-gray-800">L'Ancrage :</strong> Rester figé sur le prix d'achat initial, ce qui empêche de vendre un titre perdant[cite: 75].
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    <div class="bg-purple-100 p-2 rounded text-purple-600 mt-1">3</div>
                    <div>
                        [cite_start]<strong class="text-gray-800">L'Excès de Confiance :</strong> Surestimer sa capacité à "battre le marché"[cite: 77].
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center">
                <div>
                    <p class="text-indigo-100 mb-4 leading-relaxed">
                        C'est l'argent qui travaille pour l'argent. [cite_start]Les gains sont réinvestis pour générer de nouveaux gains[cite: 81].
                    </p>
                    ...
                    <div class="bg-green-600/20 p-4 rounded-lg border border-green-500/30">
                        ...
                        <p class="text-sm text-indigo-100">Un baobab grandit lentement au début, puis sa croissance accélère massivement. [cite_start]C'est le temps, pas l'effort, qui crée sa majesté[cite: 86].</p>
                    </div>
                </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="grid md:grid-cols-3 gap-4 mb-8">
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    [cite_start]<p class="text-sm text-gray-600">Acheter des "bonnes affaires" en dessous de leur valeur réelle (Style Warren Buffett)[cite: 97].</p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="font-bold text-indigo-700 mb-2">🚀 Growth Investing</h3>
                    [cite_start]<p class="text-sm text-gray-600">Acheter des entreprises à forte croissance, même si elles semblent chères[cite: 99].</p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="font-bold text-indigo-700 mb-2">💰 Dividendes</h3>
                    [cite_start]<p class="text-sm text-gray-600">Viser des revenus réguliers via des entreprises matures (Banques, Télécoms)[cite: 101].</p>
                </div>
            </div>

            <div class="bg-red-50 p-5 rounded-xl border-l-4 border-red-500">
                [cite_start]<h3 class="font-bold text-red-800 mb-3">🚫 3 Erreurs à Éviter [cite: 88]</h3>
                <ul class="list-disc list-inside space-y-1 text-red-700 text-sm">
                    [cite_start]<li><strong>Timer le marché :</strong> Essayer de deviner le point le plus bas[cite: 90].</li>
                    [cite_start]<li><strong>Manquer de diversification :</strong> Tout miser sur une seule action[cite: 92].</li>
                    [cite_start]<li><strong>Vendre en Panique :</strong> Réagir émotionnellement à une baisse[cite: 94].</li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-gray-800 text-gray-300 p-8 rounded-xl border border-gray-700">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="text-white font-medium">
                    En résumé : Quand le marché panique, c'est le moment d'acheter. [cite_start]Quand tout le monde s'emballe, c'est le moment d'être prudent [cite: 106-107].
                </p>
            </div>
        </div>
        ...
        <div class="bg-purple-900 text-purple-50 p-8 rounded-xl">
            ...
            <div class="grid md:grid-cols-2 gap-x-8 gap-y-4 text-sm mb-8">
                <div class="flex flex-col">
                    ...
                    [cite_start]<span class="opacity-80">Gains réinvestis pour produire de nouveaux gains[cite: 109].</span>
                </div>
                <div class="flex flex-col">
                    <strong class="text-white">Biais Cognitif</strong>
                    [cite_start]<span class="opacity-80">Erreur de jugement basée sur des émotions[cite: 109].</span>
                </div>
                <div class="flex flex-col">
                    <strong class="text-white">Ancrage</strong>
                    [cite_start]<span class="opacity-80">Rester bloqué sur son prix d'achat initial[cite: 109].</span>
                </div>
                <div class="flex flex-col">
                    <strong class="text-white">Value Investing</strong>
                    [cite_start]<span class="opacity-80">Acheter des titres sous-évalués[cite: 109].</span>
                </div>
            </div>
    ...
    <div class="space-y-8 max-w-4xl mx-auto">
        ...
        <div class="bg-gradient-to-r from-emerald-700 to-teal-800 text-white p-8 rounded-2xl shadow-lg">
            ...
            <ul class="space-y-3 text-lg">
                <li class="flex items-start gap-3">
                    ...
                    [cite_start]<strong>Lire et comprendre la logique</strong> des trois états financiers (Compte de Résultat, Bilan, Cash Flow)[cite: 4].
                </li>
                <li class="flex items-start gap-3">
                    <span class="bg-white/20 rounded-full p-1 mt-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    </span>
                    [cite_start]<strong>Calculer et interpréter les ratios clés</strong> (PER, ROE, Marge Nette) pour évaluer la santé financière[cite: 5].
                </li>
                <li class="flex items-start gap-3">
                    <span class="bg-white/20 rounded-full p-1 mt-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    </span>
                    [cite_start]<strong>Déterminer la valeur intrinsèque</strong> pour savoir si une action est chère ou bon marché[cite: 6].
                </li>
            </ul>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p class="text-gray-600 mb-6">
                Pour évaluer la santé d'une entreprise, vous avez besoin de ses trois états financiers. [cite_start]L'analyste étudie les tendances sur 5 ans[cite: 30].
            </p>
            ...
            <div class="grid md:grid-cols-3 gap-4 mb-6 mt-6">
                <div class="bg-blue-50 p-4 rounded-xl border border-blue-100">
                    ...
                    <p class="text-sm text-gray-700">Mesure la <strong>performance</strong> sur une période. [cite_start]<br>Clé : Chiffre d'Affaires vs Bénéfice Net[cite: 16].</p>
                </div>
                <div class="bg-amber-50 p-4 rounded-xl border border-amber-100">
                    ...
                    <p class="text-sm text-gray-700">Une <strong>photo à l'instant T</strong>. [cite_start]<br>Clé : Actifs = Passifs + Capitaux Propres[cite: 20].</p>
                </div>
                <div class="bg-emerald-50 p-4 rounded-xl border border-emerald-100">
                    ...
                    <p class="text-sm text-gray-700">Le plus <strong>honnête</strong>. [cite_start]Montre les mouvements réels de liquide (nécessaire pour les dividendes)[cite: 24, 27].</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="space-y-8">
                <div>
                    ...
                    [cite_start]<p class="text-gray-600 text-sm">Une marge stable ou en hausse (ex: 15%) montre que l'entreprise contrôle ses coûts[cite: 37].</p>
                </div>
                ...
                <div>
                    ...
                    <div class="bg-red-50 border-l-4 border-red-500 p-3">
                        [cite_start]<p class="text-sm text-red-800"><strong>Attention :</strong> Si Dette > Capitaux Propres, l'entreprise est vulnérable aux crises[cite: 42].</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    [cite_start]<p class="text-xs text-gray-500 mt-2 italic">Note : À la BRVM, ne rejetez pas une action juste pour un PER élevé si le potentiel est fort[cite: 61].</p>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center">
                <div>
                    ...
                    <p class="text-slate-200 text-sm mb-4">
                        Indique combien de bénéfice est généré pour chaque 100 FCFA investi par les actionnaires. > [cite_start]15% est excellent[cite: 66].
                    </p>
                </div>
                <div class="bg-emerald-900/50 p-4 rounded-lg border border-emerald-500/30">
                    ...
                    <p class="text-sm text-slate-200 italic leading-relaxed">
                        [cite_start]"Un maquis peut avoir de grosses ventes, mais s'il gaspille les ingrédients, il est inefficace. Le ROE mesure si le gérant transforme bien votre argent en profit." [cite: 69-71]
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-900 text-gray-300 p-8 rounded-xl">
            ...
            <div class="grid md:grid-cols-2 gap-4 text-sm mb-8">
                ...
                [cite_start]<p><strong class="text-emerald-400">Valeur Intrinsèque :</strong> La "vraie" valeur estimée, hors prix bourse[cite: 93].</p>
