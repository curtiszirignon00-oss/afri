  ...
  if (!data || data.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 className="text-base font-semibold text-gray-700 mb-2">Aucun certificat pour l'instant</h3>
        <p className="text-sm text-gray-500 max-w-xs">
          🎓 Vos certificats apparaîtront ici après chaque webinaire complété. Inscrivez-vous au prochain webinaire !
        </p>
      </div>
    );
  }
