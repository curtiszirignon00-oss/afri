...
const FAQ = [
  ...
  },
  {
    ...
    a: "Wave (Côte d'Ivoire), Orange Money, MTN Mobile Money et Moov Money. Disponibles dans tous les pays UEMOA (Sénégal, Côte d'Ivoire, Burkina Faso, Mali, Niger, Bénin, Togo, Guinée-Bissau).",
  },
  {
